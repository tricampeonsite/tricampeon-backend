export default (getParameter_get) => {
    let number;

    if (getParameter_get == "QTNfQ2luZQ==" || 
    getParameter_get == "Rmxvd19NdXNpY19YUA==" || 
    getParameter_get == "QUVIRA==" || 
    getParameter_get == "SG9sYV9UVg==" || 
    getParameter_get == "QVhOSEQ=" || 
    getParameter_get == "TVRWMDA=" || 
    getParameter_get == "V2FybmVySEQ=" || 
    getParameter_get == "R0VOX1RW" || 
    getParameter_get == "Rm94X1Nwb3J0c19QcmVtaXVuX0hE" || 
    getParameter_get == "VHlDU3BvcnQ" || 
    getParameter_get == "VG9kb05vdGljaWFz" || 
    getParameter_get == "QW1lcmljYTI0" || 
    getParameter_get == "QzVO" || 
    getParameter_get == "TGFfTmFjaW9u" || 
    getParameter_get == "Q3JvbmljYVRW" || 
    getParameter_get == "Q2FuYWxfOF9UdWN1bWFu" || 
    getParameter_get == "UGFyYWd1YXlfVFY=" || 
    getParameter_get == "UGFyYW1vdW50" || 
    getParameter_get == "Q29tZWR5Q2VudHJhbA" || 
    getParameter_get == "Rmxvd19NdXNpY18x" || 
    getParameter_get == "Rmxvd19NdXNpY18y" || 
    getParameter_get == "Rmxvd19NdXNpY18z" || 
    getParameter_get == "Qm9vbWVyYW5n" || 
    getParameter_get == "RHJlYW13b3Jrcw==" || 
    getParameter_get == "QW5pbWFsUGxhbmV0" || 
    getParameter_get == "SGlzdG9yeUhE" || 
    getParameter_get == "SUQ=" || 
    getParameter_get == "QnJhdm9UVg==" || 
    getParameter_get == "U29ueUhE" || 
    getParameter_get == "VHJ1VFY=" || 
    getParameter_get == "SEJPX1BPUA==" || 
    getParameter_get == "RGlzY292ZXJ5VHVyYm8=" || 
    getParameter_get == "RGlzbmV5SnI=" || 
    getParameter_get == "SW52ZXN0aWdhY2lvbl9QZXJpb2Rpc3RpY2E=" || 
    getParameter_get == "Rm94U3BvcnRzMl9VWQ==" || 
    getParameter_get == "RVNQTjQ=" || 
    getParameter_get == "Rm94U3BvcnRzM19VWQ==" || 
    getParameter_get == "RXZlbnRvc19IRF9VeQ==") {
        number = 7;
    } else if (getParameter_get == "RVNQTjJfQXJn" || 
    getParameter_get == "RXZlbnRvc18yX0hE" || 
    getParameter_get == "Q2FuYWxfOF9DQkE" || 
    getParameter_get == "MjZfVFZfSEQ" || 
    getParameter_get == "RGlwdXRhZG9zX1RW" || 
    getParameter_get == "QXJnZW50aW5pc2ltYQ" || 
    getParameter_get == "TWV0cm8" || 
    getParameter_get == "QkJDX1dvcmxkX05ld3M" || 
    getParameter_get == "VGhlYXRlcl9IRA==" || 
    getParameter_get == "R2xpdHo=" || 
    getParameter_get == "UXVpZXJvX0hE" || 
    getParameter_get == "RGlzY292ZXJ5X1dvcmxkX0hE" || 
    getParameter_get == "RXVyb2NoYW5uZWw=" || 
    getParameter_get == "RGlzY292ZXJ5X1NjaWVuY2U=" || 
    getParameter_get == "SU5DQUFfVHY=" || 
    getParameter_get == "VFY1X01vbmRl" || 
    getParameter_get == "TVRWX0hpdHM=" || 
    getParameter_get == "TVRWX0hE" || 
    getParameter_get == "Tmlja19Kcg==" || 
    getParameter_get == "VFZfRXNwYW5h" || 
    getParameter_get == "V09CSQ==" || 
    getParameter_get == "Vm9sdmVy" || 
    getParameter_get == "VGVsZXN1cg==" || 
    getParameter_get == "TGlmZXRpbWU=" || 
    getParameter_get == "QW50ZW5hXzM=" || 
    getParameter_get == "UGxheWJveQ==" || 
    getParameter_get == "Rm94X05ld3M=" || 
    getParameter_get == "VHZfQ2hpbGU=" || 
    getParameter_get == "TWFzX0NoaWM=" || 
    getParameter_get == "U3R1ZGlvX1VuaXZlcnNhbA==" || 
    getParameter_get == "SVNBVA==" || 
    getParameter_get == "U3VuX0NoYW5uZWw=" || 
    getParameter_get == "UkFJ" || 
    getParameter_get == "VmVudXM=" || 
    getParameter_get == "Q2FuYWw3" || 
    getParameter_get == "VE5UX1Nwb3J0c19IRA" || 
    getParameter_get == "VGVsZWZlSEQ=" || 
    getParameter_get == "Q2luZW1heA==" || 
    getParameter_get == "U2V4dHJlbWU=" || 
    getParameter_get == "RW5jdWVudHJv" || 
    getParameter_get == "VGVsZW1heA==" || 
    getParameter_get == "TmV0X1RW" || 
    getParameter_get == "Q2FuYWxfMTJfQ0JB" || 
    getParameter_get == "RWxfR2FyYWdl" || 
    getParameter_get == "RmlsbV9BcnRz" || 
    getParameter_get == "VW5pdmVyc2FsX0NoYW5uZWxfSEQ=" || 
    getParameter_get == "RXVyb3BhX0V1cm9wYQ==" || 
    getParameter_get == "RXVyb25ld3M=" || 
    getParameter_get == "Rm9vZF9OZXR3b3Jr" || 
    getParameter_get == "RV9FbnRlcnRhaW5tZW50X1RlbGV2aXNpb24=" || 
    getParameter_get == "Q00=" || 
    getParameter_get == "UEFLQV9QQUtB" || 
    getParameter_get == "SGlzdG9yeV8y" || 
    getParameter_get == "U3lGeQ==" || 
    getParameter_get == "VEJT" || 
    getParameter_get == "VENN" || 
    getParameter_get == "SEJPXzI=" || 
    getParameter_get == "SEJPX1BsdXM=" || 
    getParameter_get == "SEJPX0ZhbWlseQ==" || 
    getParameter_get == "SEJPX0V4dHJlbWU=" || 
    getParameter_get == "SEJPX011bmRp" || 
    getParameter_get == "SEJPX1NpZ25hdHVyZQ==" || 
    getParameter_get == "Q2FuYWxfUnVyYWw=" || 
    getParameter_get == "TExD" || 
    getParameter_get == "Q2FuYWxfZGVfbGFfY2l1ZGFk" || 
    getParameter_get == "RGlzY292ZXJ5X0tpZHM=" || 
    getParameter_get == "SFRW" || 
    getParameter_get == "TkJBX1RW" || 
    ...
    getParameter_get == "VW5pdmVyc2FsX1JlYWxpdHk="){
        ...
        number = 5;
    } else if (getParameter_get == "Q2FuYWxfNV9Sb3Nhcmlv" || 
    getParameter_get == "VEVMRUZVVFVST19DNA==" ||
    getParameter_get == "VGVsZWZlX05ldXF1ZW4=" || 
    getParameter_get == "VGVsZWZlX1NhbHRh" || 
    getParameter_get == "U05UX0M0" || 
    getParameter_get == "UEFSQVZJU0lPTl9DNA==" || 
    getParameter_get == "Tk9USUNJQVNfUFlfQzQ=" || 
    getParameter_get == "TEFfVEVMRV9DNA==" || 
    getParameter_get == "U1VSX1RWX0M0" || 
    getParameter_get == "Q2FuYWwxMlVSVQ=="  || 
    getParameter_get == "RGlzY292ZXJ5SG9tZUhlYWx0aEhE" || 
    getParameter_get == "Q2FuYWw0X1VSVQ==" || 
    getParameter_get == "SEJPSEQ="  || 
    getParameter_get == "Q2FuYWwxMF9VUlU=" || 
    getParameter_get == "UlBDX0M0"){ 
        number = 4;
    } else if (getParameter_get == "RGlzY292ZXJ5SG9tZUhlYWx0aEhE" ||
     getParameter_get == "TmF0R2VvSEQ="  || 
     getParameter_get == "VE5UX0hEX0FyZw=="  || 
     getParameter_get == "VE5UU2VyaWVz" || 
     getParameter_get == "Q2FydG9vbk5ldHdvcms=" || 
...
//     number = 5;
//     else if (getURL == "RGlzY292ZXJ5SG9tZUhlYWx0aEhE" || getURL == "TmF0R2VvSEQ="  || getURL == "VE5UX0hEX0FyZw=="  || getURL == "VE5UU2VyaWVz" || getURL == "Q2FydG9vbk5ldHdvcms=" || getURL == "Tmlja2Vsb2Rlb24="  || getURL == "QWR1bHRfU3dpbQ==" ) 
//     number = 3;
...
//     var mt = [  "edge-live02-mun",  "edge-live02-bel",  "edge6-ccast-sl",   "edge-mix02-cte",  "edge-mix04-coe" ];
...
//         let subdomain = mt[i];
//         let mpdURL = "//" + subdomain + ".cvattv.com.ar/live/c" + number + "eds/" + atob(getURL) + "/SA_Live_dash_enc/" + atob(getURL) + ".mpd";
...
//     else if (getURL == "RXZlbnRvc19IRF9VeQ==") // Eventos 1 UY
//     {
...
//     else if (getURL == "QWR1bHRfU3dpbQ==") // AS
//     {
